export const metadata = {
    title: "Datenschutz - PushQuantum",
    description: "Datenschutzerklärung von PushQuantum e.V.",
};
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 py-12 lg:py-16">
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-4 text-gray-400 text-base lg:text-lg">
                            Datenschutzerklarung gem. DSGVO
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="mx-auto max-w-3xl">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <p className="text-[#1a1a2e]/80 leading-relaxed">
                                    ...
                                    unsere IT-Systeme erfasst (z. B. Browser, Betriebssystem
                                    oder Zeitpunkt des Seitenaufrufs).
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-[#1a1a2e]/80 leading-relaxed">
                                    ...
                                    Löschung dieser Daten verlangen. Sie können eine erteilte
                                    Einwilligung zur Datenverarbeitung jederzeit für die Zukunft
                                    widerrufen. Außerdem haben Sie das Recht, unter bestimmten
                                    Umständen die Einschränkung der Verarbeitung Ihrer Daten zu
                                    verlangen. Zusätzlich steht Ihnen ein Beschwerderecht bei
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-[#1a1a2e]/80 leading-relaxed">
                            ...
                            auf den Servern dieses Dienstleisters gespeichert. Der Einsatz
                            des Hosters erfolgt zur Vertragserfüllung sowie im berechtigten
                            Interesse an einer sicheren, schnellen Bereitstellung unseres
                            Online-Angebots.
                        </p>
                    </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <p className="text-[#1a1a2e]/80 leading-relaxed">
                                    ...
                                    Verarbeitung entfällt oder Sie der Speicherung widersprechen

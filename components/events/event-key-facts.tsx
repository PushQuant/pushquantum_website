    ...
    <section className="py-16 px-6 bg-white">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="flex flex-col gap-6">
          {facts.when && (
            <div>
              <h3 className="font-bold text-[#1a1a2e]">When?</h3>
          ...
          {facts.where && (
            <div>
              <h3 className="font-bold text-[#1a1a2e]">Where?</h3>
          ...
          {facts.forWhom && (
            <div>
              <h3 className="font-bold text-[#1a1a2e]">For whom?</h3>
          ...
          {facts.whatToExpect && (
            <div>
              <h3 className="font-bold text-[#1a1a2e]">What to expect?</h3>
